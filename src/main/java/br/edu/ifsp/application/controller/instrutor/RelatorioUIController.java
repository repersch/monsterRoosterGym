...
public class RelatorioUIController {
    ...
    @FXML
    public Button btnRelatorioFichaTreino;
    @FXML
...
//                listViewMenu.setItems();
    ...
    public void verFichaTreino(ActionEvent actionEvent) throws IOException {
        ...
        WindowLoader.setRoot("instrutor/RelatorioFichaTreinoUI", new Dados(usuarioAutenticado.getId(), alunoSelecionado.getId(), 0));
    }
